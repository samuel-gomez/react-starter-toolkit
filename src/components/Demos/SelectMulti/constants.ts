...
export const ROUTE_URL_SELECT_MULTI = 'selectMulti';
export const STORYBOOK_PATH = 'form-input-selectmulti--multiselect';
export const DESIGN_SYSTEM_PATH = 'form-select/';
export const GITHUB_PACKAGE = 'Form/Input/select-multi';
export const NPM_NAME = '%40axa-fr%2Freact-toolkit-form-input-select-multi';
