Feature: Consultation des sociétaires
  ...
  Scenario: Affichage de la liste des sociétaires
    ...
    And le tableau présente 3 colonnes dans l’ordre suivant : ’Nom’, ‘Prénom’, ‘Date de naissance’, ‘type’
    And le tableau contient 1 ligne correspondant à un sociétaire avec 3 colonnes dans l’ordre suivant :’Samuel’, ‘Gomez’, ‘20/10/1985’, ‘PP’
